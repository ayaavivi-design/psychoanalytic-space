...
const CRISIS_KEYWORDS_HE = [
  ...
  // הערה: 'רוצה לסיים' לבד הוצא — false positive גבוה מדי
  'רוצה שזה ייגמר', 'רוצה שהכל ייגמר',
  'מיואש מהחיים', 'מיואשת מהחיים', 'יאוש מהחיים', 'נואש מהחיים', 'נואשת מהחיים',
  'עייפתי מהחיים', 'עייף מהחיים', 'עייפה מהחיים',
  'לא שווה לחיות', 'החיים לא שווים',
  'נמאס לי לחיות', 'נמאס לי מהחיים',
  'לא רוצה את החיים האלה', 'לא רוצה להיות פה',
  'הייתי רוצה להיעלם', 'הייתי רוצה לא להתעורר',
];
