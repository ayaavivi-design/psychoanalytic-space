...
export default function Home() {
  ...
  const THEORIST_LIST: [string, string, string][] = (['freud','klein','winnicott','ogden','loewald','bion','kohut','heimann'] as const).map(k => [k, THEORIST_LABELS[k][0], THEORIST_LABELS[k][1]]);
