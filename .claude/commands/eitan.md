...
**Jira:** פרויקט BTW. כל FAIL ב-QA → צור bug report אוטומטית עם label `qa-report`. WARNING חמור → צור task עם priority Medium. השתמש בסקיל `/jira` לביצוע. אל תיצור duplicates — בדוק קודם אם issue כבר קיים.
