...
const UI_TRANSLATIONS = {
  he: {
    ...
    authDisclaimer: 'Between נבנה לזמן שבין פגישות הטיפול — לא במקומן. פסיכואנליזה מתרחשת בין שני בני אדם: בנוכחות, בקשר, ובזמן. הממשק נועד לצד המטפל, לא במקומו.',
  ...
  en: {
    ...
    authDisclaimer: 'Between is built for the time between therapy sessions — not instead of them. Psychoanalysis takes place between two people: in presence, in relationship, in time. This interface is meant to stand beside the therapist, not in place of one.',
