...
const UI_TRANSLATIONS = {
  he: {
    ...
    agentLabel: 'הסוכן',
    userLabel: 'שאלתך',
    placeholderClinical: 'תאר/י מצב — מה מרגישים? מה קורה? מה מסקרן?',
    newChat: 'שיחה חדשה',
    ...
    authDisclaimer: 'Between הוא כלי לחשיבה ולהבנה עצמית ולא תחליף לטיפול. הוא נועד ללוות אנשים שנמצאים בתהליך: בטיפול, בהכשרה, או בחקירה עצמית. פסיכואנליזה מתרחשת בין שני בני אדם בנוכחות, בקשר, ובזמן. הממשק נועד לצד המטפל, לא במקומו.',
  ...
  en: {
    ...
    authDisclaimer: 'Between is a tool for reflection and self-understanding, not a substitute for therapy. It is designed to accompany people who are in therapy, in training, or in self-inquiry. Psychoanalysis takes place between two people — in presence, in relationship, in time. This interface is meant to stand beside the therapist, not in place of one.',
...
const CRISIS_KEYWORDS = [
  ...
  // ביטויים קולוקוויאליים — נוספו 10.5.2026 אחרי בדיקה ידנית
  'בא לי למות','באה לי למות','בא לה למות','בא לו למות',
  'מת מרוב','אני מת','אני מתה','מרגיש כמו מוות','מרגישה כמו מוות',
  'לא רואה טעם להמשיך','אין לי טעם להמשיך','יהיה יותר קל בלעדיי',
  'אם לא הייתי כאן','הייתי עושה לכולם טובה אם','לא הייתי מתגעגע אלי','לא היו מתגעגעים אלי',
  'נמאס לי לחיות','עייף מלחיות','עייפה מלחיות','לא יכול יותר להיות','לא יכולה יותר להיות',
  ...
  'i want to die','i feel like dying','feel like dying'
];
...
const USER_FEEDBACK_PERSONAS = {
  michal: { label: 'מיכל — מטופלת, 33, 2.5 שנות טיפול' },
};
