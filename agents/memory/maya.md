...
## Context
- design-system.html: v1.2 — מסונכרן עם globals.css (יוני 2026: accent-deep swatch, font-david, layout-content-max, RTL flip fix, heading-sm הוסר, heading-lg→David Libre)
