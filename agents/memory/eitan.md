...
- **קליין — דפוס over-question חוזר**: Q-3 (01.06), נקי 02-05.06, Q-1 חזר 06.06 (שתי שאלות תור 3 — נתפס בפרודקשן). הכשל מופיע בצורות שונות (Q-3 / Q-1) — אותו שורש.
...
- **06.06 סטטוס**: 3/4 PASS מלא + קליין 🟡 (Q-1 נתפס בפרודקשן). RAG=3 לכולם. Klein Q-3 structural fix (check 5a, שורה ~883 theorist-voices.ts) — **לא בוצע עדיין, HIGH priority לפי ליה 04.06 — דחוף לביצוע**.
