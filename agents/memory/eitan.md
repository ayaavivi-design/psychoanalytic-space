...
- **קליין O-7 — דפוס חוזר**: הופיע 30.05, נעלם 31.05, חזר 01.06, נעלם 02.06–04.06. 3/5 ימים. לא תוקן בפרומפט — שונות מודל, לא תיקון. אם יחזור שוב → prompt fix.
- **קליין Q-3 — all-questions pattern**: הופיע 01.06 בלבד. קורלציה לאותה ריצה גרועה של 01.06. לא תוקן.
...
- **05.06 סטטוס**: 4/4 PASS, RAG=3 לכולם. חמישה ימים רצופים נקיים (02.06–05.06). Klein Q-3 structural fix (check 5a, שורה ~883 theorist-voices.ts) — **לא בוצע עדיין, HIGH priority לפי ליה 04.06**.
