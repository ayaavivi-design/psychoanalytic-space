...
## History (last 10)
1. ניתוח שיחת ויניקוט — "דברים שנשפכו בטיפול" 22.05: 4 פערים מבניים חדשים — (1) בינארי השוואתי "X יותר מ-Y?" לא כוסה ב-DO NOT OFFER ALTERNATIVES; (2) "נשמע כמו" נתפס רק כ-opener, לא באמצע תגובה; (3) טריגר בושה חסר ב-WHEN TO POINT TOWARD THERAPY — branch שגוי הופעל; (4) נוסחה מהדוגמאות שוחזרה מילה במילה. כל 4 תוקנו. (מאי 2026)
